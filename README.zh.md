...
- [tonytanglab/deepseek-harness-relay-mcp#dsh-relay](https://github.com/tonytanglab/deepseek-harness-relay-mcp/tree/main/plugins/dsh-relay) — 在 Web profile 中安装适配层，检测并写入 MCP 配置，供 Codex、Cursor 或 Claude Code 拉起 dsh --profile codex.
